...
export function PasswordInputStrengthChecker() {
  const [zxcvbnInstance, setZxcvbnInstance] = useState<ZxcvbnFactory | null>(
    null,
  );
  ...
  function getLabel() {
    ...
    if (zxcvbnInstance == null) return "Loading strength checker";
